package com.example.open_camera_flutter
...
class OpenCameraFlutterPlugin: FlutterPlugin, MethodCallHandler, ActivityAware,
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "open_camera_flutter")
